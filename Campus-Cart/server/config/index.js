...
const database =
  process.env.NODE_ENV === "test"
    ...
    : process.env.POSTGRES_DB || 'pernstore';

// 为所有变量添加默认值
const connectionString = `postgresql://${process.env.POSTGRES_USER || 'postgres'}:${process.env.POSTGRES_PASSWORD || '123456'}@${process.env.POSTGRES_HOST || 'localhost'}:${process.env.POSTGRES_PORT || 5432}/${database}`;
